...
function preload(){
  ...
  boyFailImg = loadAnimation("Runner-1.png")
}
...
gameoverImg=createSprite(windowWidth/2,windowHeight/2);
...
//depths
cashG.depth=gameoverImg.depth-1;
diamondsG.depth=gameoverImg.depth-1;
jwelleryG.depth=gameoverImg.depth-1;
swordGroup.depth=gameoverImg.depth-1;
  ...
  path.y = windowHeight/4.8
    ...
    if (cashG.isTouching(boy)) {
      ...
      if(swordGroup.isTouching(boy)) {
        ...
        boy.changeAnimation("SahilRunning",boyFailImg);
